...
object SumaReactivaNumeros extends App {
  ...
  val sumaElementos = Signal [Int] { calificaciones.value.sum }

  val observer = sumaElementos.changed.observe { valor =>
...
<img width="296" height="104" alt="image" src="https://github.com/user-attachments/assets/f79fba92-aa28-4813-ae4c-08bdf59140d5" />
...
object EnergiaCinetica extends App {
  ...
  val observador = energiaCinetica.observe { valor =>
...
```
### Captura de la ejecucion 
<img width="476" height="156" alt="image" src="https://github.com/user-attachments/assets/5e409942-69ba-49fc-abbf-1999946a916d" />
